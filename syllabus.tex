...
\newcommand{\thesemester}{Febrero--Junio 2019}
\newcommand{\theinstructor}{Xavier Sánchez Díaz}
\newcommand{\themail}{mail@tec.mx}
\newcommand{\thetime}{Mi 15:00--18:00 hrs}
...
\begin{document}
  ...
  \begin{enumerate}
  \item \url{https://saxarona.gitlab.io/teaching/tc1003/}
  \end{enumerate}

  \vskip.15in

  \noindent\textbf{Horario de oficina:}
  Usualmente puedes encontrarme los días lunes y jueves de 10:00 a 12:00 hrs en la oficina (CT-524, CETEC Sur).
  ...
  \begin{itemize}
    \item Oscar Levin, \textit{Discrete Mathematics, An Open Introduction}, 3rd ed. \\
    Disponible en: \url{http://discrete.openmathbooks.org/dmoi3.html}
    \item Sussana S. Epp, \textit{Discrete mathematics with applications}, 3rd ed. Belmont, CA : Thomson-Brooks/Cole.
    \item David Makinson, \textit{Sets, Logic and Maths for Computing}. Springer, London.
  \end{itemize}

  \vskip.15in

  \noindent\textbf{Objetivo del curso:}
  Éste es un curso hecho para que aprendas a utilizar herramientas matemáticas para modelar situaciones de la vida real, como los conjuntos, funciones, predicados y grafos.
  Requiere de conocimientos previos de matemáticas básicas del nivel preparatoria.
  Como resultado del aprendizaje el alumno logra hacer una presentación formal y rigurosa de problemas de computación y electrónica y su posible solución, haciendo uso del razonamiento formal.

  \vskip.15in
  \noindent\textbf{Requisitos:}
  Haber aprobado (o estar actualmente cursando) Introducción a las Matemáticas (MA1001).
  ...
  \begin{flushleft}
  Examen 1 \dotfill ~18 de marzo \\
  Semana Santa \dotfill ~4--12 de abril\\
  Examen 2 \dotfill ~29 de abril \\
  Examen 3 \dotfill ~Fecha de examen final
  \end{flushleft}
  \end{minipage}
  \end{center}
