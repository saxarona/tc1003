...
\begin{center}
	...
	\bigskip
	{\large \textbf{AEX02 -- Prueba matemática}}
\end{center}
...
Usando cualquier método de prueba, demuestra que $A \equiv \neg \neg A$.

\vspace{45ex}

Demuestra que la regla de \textit{reductio ad absurdum} es válida:

$$\inference{\neg A \implies false}{A}$$

\pagebreak

Demuestra recursivamente la función exponencial $2^n$ para $\mathbb{N}\cup\{0\}$
